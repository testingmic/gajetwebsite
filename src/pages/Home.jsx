...
const services = [
  {
    ...
    desc: 'Residential, commercial, and civil infrastructure projects delivered with modern engineering and strict quality control.',
    href: '/services#construction',
  },
  {
    icon: Pickaxe,
    title: 'Mining Services',
    desc: 'Exploration support, mine development, extraction, and operational services with emphasis on safety and environmental responsibility.',
    href: '/services#mining',
  },
  {
    icon: Truck,
    title: 'Logistics Services',
    desc: 'End-to-end transportation, haulage, storage, and supply chain coordination with real-time responsiveness.',
    href: '/services#logistics',
  },
  {
    icon: BarChart3,
    title: 'Commodities Trading',
    desc: 'Connecting producers to global markets with transparency, market intelligence, and strong partner relationships.',
...
const featuredProjects = [
  {
    imgKey: 'project1',
    label:  'home-project-1.jpg',
    title:  'Residential Estate Development',
    category: 'Building & Construction',
    location: 'Ghana',
    desc: 'A landmark residential development delivering modern housing with quality craftsmanship and on-time execution.',
  },
  {
    imgKey: 'project2',
    label:  'home-project-2.jpg',
    title:  'Mine Site Operations Support',
    category: 'Mining Services',
    location: 'West Africa',
    desc: 'Full operational and logistical support for an active mining site, ensuring efficiency, safety, and environmental compliance.',
  },
  {
    imgKey: 'project3',
    label:  'home-project-3.jpg',
    title:  'National Road Rehabilitation',
    category: 'Roads Construction',
    location: 'Ghana',
    desc: 'Rehabilitation of a major arterial road network using modern civil engineering methods and durable materials.',
  },
];

const gallerySlots = [
  { key: 'gallery1', label: 'home-gallery-1.jpg', span: 'row-span-2' },
  { key: 'gallery2', label: 'home-gallery-2.jpg', span: '' },
  { key: 'gallery3', label: 'home-gallery-3.jpg', span: '' },
  { key: 'gallery4', label: 'home-gallery-4.jpg', span: '' },
  { key: 'gallery5', label: 'home-gallery-5.jpg', span: '' },
];
    ...
    <main>
      ...
      <section className="relative min-h-screen flex items-center bg-navy-900 overflow-hidden">
        ...
        {HOME.heroBg ? (
          <ImgSlot
            src={HOME.heroBg}
            alt="Gajet Resources hero"
            className="absolute inset-0 w-full h-full object-cover opacity-25"
          />
        ) : (
          /* Diagonal line pattern fallback */
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-display font-black text-4xl sm:text-5xl xl:text-6xl text-white leading-[1.1] mb-6">
                Inspiring the World
                <span className="block text-gold-400">Through Excellence</span>
                and Leadership
              </h1>
                ...
                <svg className="absolute inset-0 w-full h-full animate-[spin_20s_linear_infinite]" viewBox="0 0 288 288">
                  ...
                  <text fontSize="11" fill="rgba(245,158,11,0.7)" letterSpacing="4" fontFamily="Montserrat,sans-serif" fontWeight="600">
                    <textPath href="#circlePath">
                      EXCELLENCE • INTEGRITY • LEADERSHIP • VISION • STRENGTH •&nbsp;
                    </textPath>
                  </text>
                </svg>
              </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map(stat => (
              <div key={stat.label} className="text-center py-5 px-4 rounded-xl bg-white/5 border border-white/10">
                <p className="font-display font-black text-3xl text-gold-400 mb-1">{stat.value}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="What We Do"
            title="Integrated Solutions Across Key Sectors"
            subtitle="We combine technical capability, innovation, and ethical business practices to deliver sustainable value across all our operations."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map(({ icon: Icon, title, desc, href }) => (
              <div key={title} className="bg-white rounded-2xl p-6 shadow-sm card-hover border border-gray-100 group">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="rounded-2xl overflow-hidden aspect-[4/3]">
                <ImgSlot
                  src={HOME.about}
                  alt="About Gajet Resources"
                  label="home-about.jpg"
                  className="w-full h-full"
                />
              </div>
              <div className="absolute -bottom-5 -right-5 bg-gold-500 rounded-2xl px-6 py-5 shadow-xl hidden sm:block">
            ...
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-8">
                ...
                public and private sector clients, guided by strong leadership and a commitment to
                sustainable value creation.
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {coreValues.map(v => (
                  <div key={v.label} className="flex items-center gap-3 py-3 px-4 rounded-lg bg-gray-50">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            subtitle="A selection of projects that demonstrate our capability, quality, and commitment to delivering exceptional outcomes."
          />
          <div className="grid md:grid-cols-3 gap-8">
            {featuredProjects.map(p => (
              <div key={p.title} className="bg-white rounded-2xl overflow-hidden shadow-sm card-hover border border-gray-100 group">
                {/* Image slot — 16:9 */}
      ...
      <section className="py-20 bg-navy-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            subtitle="Glimpses from across our construction sites, mining operations, and logistics network."
            light
          />
          {/* 5-slot mosaic grid */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeader
                badge="Why Choose Us"
                title="The Gajet Advantage"
                subtitle="We bring together multi-sector expertise, ethical leadership, and operational excellence to exceed client expectations."
                centered={false}
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={title} className="bg-gray-50 border border-gray-100 rounded-2xl p-5 card-hover">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Our People"
            title="Leadership Behind the Vision"
            subtitle="Experienced leaders who bring strategic clarity, operational depth, and an unwavering commitment to delivering results."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map(member => (
              <div key={member.name} className="text-center group">
                {/* Circular photo slot */}
                <div className="w-36 h-36 rounded-full overflow-hidden mx-auto mb-5 ring-4 ring-white shadow-lg group-hover:ring-gold-400 transition-all duration-300">
                  <ImgSlot
                    src={HOME[member.imgKey]}
                    alt={member.name}
                    label={member.label}
                    className="w-full h-full"
                  />
      ...
      <section className="py-20 bg-navy-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            {/* Client photo slot */}
            <div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-gold-400 shrink-0 bg-navy-800 flex items-center justify-center text-gold-400 font-bold text-lg">
              GR
            </div>
      ...
      <section className="py-16 bg-gold-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display font-bold text-3xl md:text-4xl text-navy-900 mb-4">
            Ready to Start Your Next Project?
          </h2>
          <p className="text-navy-800 text-lg mb-8 max-w-2xl mx-auto">
            Partner with Gajet Resources International Limited for world-class solutions across construction, mining, logistics, and trading.
          </p>
